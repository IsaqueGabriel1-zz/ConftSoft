Public Class Form1
    ...
    Private Sub btnLogar_MouseMove(sender As Object, e As MouseEventArgs) Handles btnLogar.MouseMove
        btnLogar.BackColor = Color.White
        btnLogar.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub

    Private Sub btnLogar_MouseLeave(sender As Object, e As EventArgs) Handles btnLogar.MouseLeave
        btnLogar.BackColor = Color.FromArgb(227, 161, 152)
        btnLogar.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub
