...
Public Class frmAreaChefeCozinha
    ...
    Private Sub btnProximoPedido__MouseMove(sender As Object, e As MouseEventArgs) Handles btnProximoPedido_.MouseMove
        btnProximoPedido_.BackColor = Color.White
        btnProximoPedido_.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub

    Private Sub btnProximoPedido__MouseLeave(sender As Object, e As EventArgs) Handles btnProximoPedido_.MouseLeave
        btnProximoPedido_.BackColor = Color.FromArgb(227, 161, 152)
        btnProximoPedido_.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub

    Private Sub btnPedidoAceito__MouseLeave(sender As Object, e As EventArgs) Handles btnPedidoAceito_.MouseLeave
        btnPedidoAceito_.BackColor = Color.FromArgb(227, 161, 152)
        btnPedidoAceito_.ForeColor = Color.FromArgb(211, 104, 90)

    End Sub

    Private Sub btnPedidoAceito__MouseHover(sender As Object, e As EventArgs) Handles btnPedidoAceito_.MouseHover
        btnPedidoAceito_.BackColor = Color.White
        btnPedidoAceito_.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub
    ...
    Private Sub btnSair_MouseMove(sender As Object, e As MouseEventArgs) Handles btnSair.MouseMove
        ...
        btnSair.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub

    Private Sub btnSair_MouseLeave(sender As Object, e As EventArgs) Handles btnSair.MouseLeave
        btnSair.BackColor = Color.FromArgb(227, 161, 152)
        btnSair.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub

    Private Sub btnPedidoAnterior__MouseMove(sender As Object, e As MouseEventArgs) Handles btnPedidoAnterior_.MouseMove
        btnPedidoAnterior_.BackColor = Color.White
        btnPedidoAnterior_.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub

    Private Sub btnPedidoAnterior__MouseLeave(sender As Object, e As EventArgs) Handles btnPedidoAnterior_.MouseLeave
        btnPedidoAnterior_.BackColor = Color.FromArgb(227, 161, 152)
        btnPedidoAnterior_.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub
