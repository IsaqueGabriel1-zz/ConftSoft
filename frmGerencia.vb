Public Class frmGerencia
    ...
    Private Sub Button1_MouseMove(sender As Object, e As MouseEventArgs) Handles Button1.MouseMove
        ...
        Button1.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub

    Private Sub Button1_MouseLeave(sender As Object, e As EventArgs) Handles Button1.MouseLeave
        Button1.BackColor = Color.FromArgb(227, 161, 152)
        Button1.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub

    Private Sub btnGerarRelátorio_MouseMove(sender As Object, e As MouseEventArgs) Handles btnGerarRelátorio.MouseMove
        btnGerarRelátorio.BackColor = Color.White
        btnGerarRelátorio.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub

    Private Sub btnGerarRelátorio_MouseLeave(sender As Object, e As EventArgs) Handles btnGerarRelátorio.MouseLeave
        btnGerarRelátorio.BackColor = Color.FromArgb(227, 161, 152)
        btnGerarRelátorio.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub

    Private Sub btnExit_MouseMove(sender As Object, e As MouseEventArgs) Handles btnExit.MouseMove
        btnExit.BackColor = Color.White
        btnExit.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub

    Private Sub btnExit_MouseLeave(sender As Object, e As EventArgs) Handles btnExit.MouseLeave
        btnExit.BackColor = Color.FromArgb(227, 161, 152)
        btnExit.ForeColor = Color.FromArgb(211, 104, 90)
    End Sub
End Class